...
def parse_args():   
    ...
    parser.add_argument("--run_name", type=str, default="mamba-sam", help="run model name")
    ...
    parser.add_argument("--gradient_clipping", type=bool, default=False, help="Enable gradient clipping")
...
def main(local_rank, args):
    ...
    train_loader = DataLoader(train_dataset, batch_size=args.batch_size, sampler=train_sampler, num_workers=4, pin_memory=True, generator=g, collate_fn=custom_collate_fn)
    val_loader = DataLoader(train_dataset, batch_size=args.batch_size, sampler=val_sampler, num_workers=4, pin_memory=True, collate_fn=custom_collate_fn)
